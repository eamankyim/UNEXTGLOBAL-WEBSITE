...
const GetStartedFlowCustomBtn = () => {
  ...
  return (
    <>
      {/* ✅ Replace this button with your own styles */}
      <button className="custom-trigger-button" onClick={() => setIsOpen(true)}>
        Start Now
      </button>
...
export default GetStartedFlowCustomBtn;
